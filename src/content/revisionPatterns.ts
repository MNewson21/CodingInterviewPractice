...
return heap                    # the k largest`,
  ...
  { id:'Sorting Algorithms',
    ...
    whenToUse: ['If you would benefit from the representation being in a non-decreasing or non-increasing order', 'To later perform a search such as Binary Search'],
